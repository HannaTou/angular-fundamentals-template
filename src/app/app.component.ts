...
//    this.searchTermByCharacters.subscribe((reqParameter: any) => this.mockDataService.getCharacters(reqParameter));
    ...
    this.charactersResults$ = this.searchTermByCharacters
        ...
        // YOUR CODE STARTS HERE
            ...
            switchMap(reqParameter => this.mockDataService.getCharacters(reqParameter))
        );
        // YOUR CODE ENDS HERE
  }
  ...
  initLoadingState(): void {
    ...
    // YOUR CODE STARTS HERE
    this.subscriptions.push(combineLatest([this.mockDataService.getCharactersLoader(), this.mockDataService.getPlanetLoader()]).subscribe((values: any) => {this.isLoading = this.areAllValuesTrue(values);}));
    // YOUR CODE ENDS HERE
  }
